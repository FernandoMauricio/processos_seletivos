...
class Contratacao extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'nome_substituicao' => 'Colaborador a ser substituido',
            ...
            'jornada_obs' => 'OBSERVAÇÃO (inserir outras informações inerentes ao processo, como, dia e horário de trabalho do novo colaborador, se precisa ter disponibilidade em outros dias e horários eventualmente, entre outras necessárias).',
            'turmas_ministradas' => 'Turmas a serem ministradas (docentes):',
            'principais_atividades' => 'Principais atividades a serem desenvolvidas pelo colaborador a ser contratado:',
