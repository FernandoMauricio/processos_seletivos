...
class ContratacaoEmAndamentoSearch extends Contratacao
{
    ...
    public function rules()
    {
        return [
            ...
            [['data_solicitacao', 'hora_solicitacao', 'colaborador', 'unidade', 'motivo','obs_aumento' ,'nome_substituicao', 'obs_deficiencia', 'data_ingresso', 'tecnico_area', 'superior_area', 'pos_area', 'dominio_atividade', 'experiencia_tempo', 'experiencia_atividade', 'jornada_obs', 'principais_atividades', 'selec_teste'], 'safe'],
        ];
    }
