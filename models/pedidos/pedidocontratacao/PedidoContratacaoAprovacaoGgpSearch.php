...
/**
 * PedidoContratacaoAprovacaoGgpSearch represents the model behind the search form about `app\models\pedidos\pedidocontratacao\PedidoContratacao`.
 */
class PedidoContratacaoAprovacaoGgpSearch extends PedidoContratacao
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'pedcontratacao_situacaoggp' => 1, // Aguardando Aprovação
