 ...
 */
class AnaliseGerencialAdministradorSearch extends Curriculos
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['edital', 'nome','numeroInscricao', 'cargo', 'cpf', 'datanascimento', 'sexo', 'email', 'emailAlt', 'telefone', 'telefoneAlt', 'data', 'unidade_aprovador'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'edital', $this->edital])
            ...
            ->andFilterWhere(['like', 'unidade_aprovador', $this->unidade_aprovador]);
