...
$this->params['breadcrumbs'][] = ['label' => 'Solicitação de Contratação', 'url' => ['contratacao/contratacao/index']];
$this->params['breadcrumbs'][] = ['label' => $id_contratacao, 'url' => ['contratacao/contratacao/view', 'id' => $id_contratacao]];
