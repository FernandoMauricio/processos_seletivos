...
/* @var $searchModel app\models\processoseletivo\ResultadosSerch */
...
<div class="resultados-index">
    ...
    <p>
        <?= Html::a('Inserir Resultado', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
        ...
        'columns' => [
            ...
            [
                         ...
                         'value' => function($model, $key, $index){
                             $url = Yii::$app->request->baseUrl . "/" . $model->resultado;
                             return Html::a($model->resultado, $url, ['target'=> '_blank']); 
                         }
            ],
