...
<div class="col-md-5"><strong>Curso Complementar: </strong><?php echo $curriculosComplemento->cursos ?></div>
<div class="col-md-5"><strong>Tem certificado: </strong><?php echo $curriculosComplemento->certificado ? 'Sim' : 'Não' ?></div>
...
<div class="panel panel-primary">
 ...
 <?php foreach ($curriculosEmpregos as $curriculosEmprego): ?>
    ...
    <div class="panel-body">
            ...
            <div class="col-md-12"><strong>Empresa: </strong><?php echo $curriculosEmprego->empresa ?></div>
            <div class="col-md-12"><strong>Cidade: </strong><?php echo $curriculosEmprego->cidade ?></div>

            <div class="col-md-12"><strong>Cargo: </strong><?php echo $curriculosEmprego->cargo ?></div>
            <div class="col-md-12"><strong>Início: </strong><?php echo $curriculosEmprego->inicio ?></div>
            <div class="col-md-12"><strong>Término: </strong><?php echo $curriculosEmprego->termino ?></div>

            <div class="col-md-12"><strong>Atividades Desenvolvidas: </strong><?php echo $curriculosEmprego->atividades ?></div>
    <hr>
    </div>
<?php endforeach; ?>
  </div>
