        ...
        <tr>
          ...
          <td>
            <?php if(isset($model->situacao_ggp)) { ?>
              <?= $model->situacao_ggp == 1 ? '<span style="color:#27ae60"><b>Classificado</b></span>' : '<span style="color:#c0392b"><b>Desclassificado</b></span>'; ?>
            <?php } ?>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <?php if(isset($model->situacao_aprovadorsolicitante)) { ?>
              <?= $model->situacao_aprovadorsolicitante  == 1 ? '<span style="color:#27ae60"><b>Classificado</b></span>' : '<span style="color:#c0392b"><b>Desclassificado</b></span>'; ?>
            <?php } ?>
          </td>
        </tr>
    </tbody>
