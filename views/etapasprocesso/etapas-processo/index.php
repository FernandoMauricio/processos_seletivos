...
$gridColumns = [
            ...
            [
              ...
              'format' => 'raw',
              'value' => function($data){
               $query = (new \yii\db\Query())->select(['contratacao_id'])->from('pedidocusto_itens')->innerJoin('contratacao', 'pedidocusto_itens.itemcusto_area = contratacao.cargo_area')->where(['itemcusto_cargo' => $data->etapa_cargo])->andWhere(['pedidocusto_id' => $data->pedidocusto_id])->andWhere(['contratacao.unidade' => $data->etapa_local]);//->andWhere(['itemcusto_unidade' => $data->etapa_local]) ->andWhere(['contratacao.unidade' => $data->etapa_local]) ->groupBy(['pedidocusto_itens.id']);;
