...
$gridColumns = [
            ...
            [
              ...
              'format' => 'raw',
              'value' => function($data){
               $query = (new \yii\db\Query())->select(['contratacao_id'])->from('pedidocusto_itens')->where(['itemcusto_cargo' => $data->etapa_cargo])->andWhere(['pedidocusto_id' => $data->pedidocusto_id])->andWhere(['LIKE', 'itemcusto_unidade', $data->etapa_local]);
