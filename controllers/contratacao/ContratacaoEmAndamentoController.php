...
use app\models\contratacao\ContratacaoEmAndamentoSearch;
...
class ContratacaoEmAndamentoController extends Controller
{
    ...
    public function actionCorrecao($id) 
    {
        ...
        return $this->redirect(Yii::$app->request->BaseUrl . '/index.php?r=contratacao/contratacao-justificativas/index', [
             'model' => $model,
         ]);
    }
